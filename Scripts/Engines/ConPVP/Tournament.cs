          ...
          try
          {
            ...
            else if (TournyType == TournyType.Faction)
            {
              if (m_ParticipantsPerMatch == 4)
              {
                ...
                switch (((TournyMatch)((PyramidLevel)Pyramid.Levels[0]).Matches[0]).Participants.IndexOf(
                  winner))
                {
                  case 0:
                  {
                  ...
                  try
                  {
                    ...
                    else if (TournyType == TournyType.Faction)
                    {
                      if (m_ParticipantsPerMatch == 4)
                      {
                        ...
                        switch (((TournyMatch)((PyramidLevel)Pyramid.Levels[0]).Matches[0])
      ...
      switch (tourneyType)
      {
        ...
        case TournyType.Standard:
        {
          if (partsPerMatch >= 2 && participants.Count % partsPerMatch == 1)
          {
            ...
            ((TournyParticipant)toAdvance[idx]).AddLog(
      ...
      switch (type)
      {
        ...
        case TournyBracketGumpType.Round_Info:
        {
          ...
          for (int i = 0; i < count; ++i, y += 18)
          {
            ...
            if (m_Tournament.TournyType == TournyType.Standard)
              for (int j = 0; j < match.Participants.Count; ++j)
              {
                ...
                sb.Append(txt);
                     ...
                     m_Tournament.TournyType == TournyType.Faction)
              for (int j = 0; j < match.Participants.Count; ++j)
              {
                if (sb.Length > 0)
                  sb.Append(" vs ");
            ...
            else if (m_Tournament.TournyType == TournyType.FreeForAll) sb.Append("Free For All");
      ...
      switch (type)
      {
        case 0:
        {
          switch (index)
          {
            ...
            case 1:
              ...
              break;
            case 2:
              m_From.SendGump(new TournamentBracketGump(m_From, m_Tournament, TournyBracketGumpType.Round_List,
                null, 0, null));
              break;
            case 4:
              m_From.SendGump(new TournamentBracketGump(m_From, m_Tournament, TournyBracketGumpType.Rules_Info,
                null, 0, null));
              break;
            case 3:
            {
        ...
        case 4:
        {
          ...
          if (m_Object is TournyParticipant part && index >= 0 && index < part.Players.Count)
            m_From.SendGump(new TournamentBracketGump(m_From, m_Tournament, TournyBracketGumpType.Player_Info,
