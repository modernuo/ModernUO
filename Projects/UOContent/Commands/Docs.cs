...
namespace Server.Commands
{
    public class Docs
    {
        ...
        */
        ...
        private static void DocumentTailorBOD(StreamWriter html, List<RewardItem> items, string amt,
            ...
            Type type)
        {
            ...
            html.WriteLine("         <tr>");
            html.WriteLine("            <td width=\"250\" class=\"entry\">&nbsp;- {0} <font size=\"1pt\">{1}</font></td>",
                name, amt);
            ...
            while (index < 20)
                ...
                else
                {
                    ...
                    html.WriteLine("            <td width=\"{0}\"{1} class=\"entry\">&nbsp;</td>", count * 25,
        ...
        private static void DocumentSmithBOD(StreamWriter html, List<RewardItem> items, string amt,
            BulkMaterialType material)
        {
            ...
            html.WriteLine("         <tr>");
            html.WriteLine("            <td width=\"250\" class=\"entry\">{0} <font size=\"1pt\">{1}</font></td>", name,
                amt);
