...
namespace Server.Mobiles
{
    public abstract partial class BaseAI
    {
        ...
        {
            return !string.IsNullOrEmpty(m_Mobile.Name) && speech.InsensitiveStartsWith(m_Mobile.Name);
        }
        ...
        {
            return m_Mobile.Combatant == from || from.Combatant == m_Mobile || IsAggressor(from) || IsAggressed(from);
        }
        ...
        {
            return trg != m_Mobile && trg.Player && trg.Alive && trg.Hidden && trg.AccessLevel == AccessLevel.Player && m_Mobile.InLOS(trg);
        }
        ...
        {
            return spawner?.ReturnOnDeactivate == true && !m_Mobile.Controlled &&
