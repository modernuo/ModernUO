...
public class SpellweavingAI( BaseCreature m ) : MageAI( m )
{
    ...
    public override Spell GetRandomBuffSpell()
    {
        ...
        {
            return new ImmolatingWeaponSpell( m_Mobile );
        }
    ...
    public override Spell GetRandomDamageSpell()
    {
        ...
        {
            case 0:
                return new ThunderstormSpell( m_Mobile );
            case 1:
                return new EssenceOfWindSpell( m_Mobile );
            case 2:
                return new WildfireSpell( m_Mobile, null );
            case 3:
                return new WordOfDeathSpell( m_Mobile );
        }
    ...
    public override Spell GetHealSpell()
    {
        ...
        if ( m_Mobile.Mana >= 24 )
        {
            return new GiftOfRenewalSpell( m_Mobile );
        }
