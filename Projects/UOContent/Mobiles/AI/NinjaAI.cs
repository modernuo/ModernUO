...
public class NinjaAI : MeleeAI
{
    ...
    public NinjaAI( BaseCreature bc ) : base( bc ) => m_NextCastTime = DateTime.UtcNow;
    ...
    public virtual SpecialMove GetSpecialMove()
    {
        ...
        {
            0 => SpellRegistry.GetSpecialMove( 500 ), //new FocusAttack();
            1 => SpellRegistry.GetSpecialMove( 503 ), //new KiAttack();
            2 => SpellRegistry.GetSpecialMove( 501 ), //new DeathStrike();
            _ => null
        };
    }
    ...
    public void DoRangedAttack()
    {
        ...
        {
            if ( item is INinjaWeapon && ( ( INinjaWeapon )item ).UsesRemaining > 0 &&
