...
public partial class BasePeerless : BaseCreature
{
    ...
    public BasePeerless( AIType aiType, FightMode fightMode, int rangePerception, int rangeFight )
    ...
    public override void OnThink()
    {
        ...
        if ( HasFireRing && Combatant != null && Alive && Hits > 0.8 * HitsMax && m_NextFireRing > Core.TickCount &&
    ...
    public override void OnDeath( Container c )
    {
        ...
        if ( GiveMLSpecial )
        {
            ...
            {
                c.DropItem( new FeyLeggings( true ) );
            }
    ...
    public virtual bool CanSpawnWave()
    {
        if ( MaxHelpersWaves > 0 && CurrentWave > 0 )
        {
            ...
            var waves = CurrentWave / ( double )( MaxHelpersWaves + 1 );
    ...
    {
        for ( var i = 0; i < m_North.Length; i += 2 )
        {
            var p = Location;
            ...
            Effects.SendLocationEffect( ( Point3D )po, Map, 0x3E27, 50 );
        }

        for ( var i = 0; i < m_East.Length; i += 2 )
        {
            var p = Location;
            ...
            Effects.SendLocationEffect( ( Point3D )po, Map, 0x3E31, 50 );
        }
