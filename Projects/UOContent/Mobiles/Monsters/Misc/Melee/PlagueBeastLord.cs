    ...
    public class PlagueBeastLord : BaseCreature, ICarvable, IScissorable
    {
        ...
        public virtual bool Scissor(Mobile from, Scissors scissors)
        {
            if (IsAccessibleTo(from))
                scissors.PublicOverheadMessage(MessageType.Regular, 0x3B2,
        ...
        public override void OnDoubleClick(Mobile from)
        {
            if (IsAccessibleTo(from))
            {
                if (OpenedBy != null && Backpack != null)
                    ...
                    PrivateOverheadMessage(MessageType.Regular, 0x3B2, 1071917,
                        from.NetState); // * You attempt to tear open the amorphous flesh, but it resists *
            }
        }
        ...
        private void BroadcastMessage()
        {
            PublicOverheadMessage(MessageType.Regular, 0x3B2,
                1071920); // * The plague beast's amorphous flesh hardens and becomes immobilized *
        }
        ...
        public virtual bool IsAccessibleTo(Mobile check)
        {
            ...
            if (!InRange(check, 2))
                ...
                PrivateOverheadMessage(MessageType.Label, 0x3B2, 500365,
                    check.NetState); // That is being used by someone else
            else if (Frozen)
                return true;
        ...
        private class DecayTimer : Timer
        {
            ...
            public DecayTimer(PlagueBeastLord lord, int count = 0, int deadline = 120) : base(TimeSpan.Zero,
            ...
            protected override void OnTick()
            {
                ...
                if (Count + 15 == Deadline)
                {
                    if (m_Lord.OpenedBy != null)
                        m_Lord.PublicOverheadMessage(MessageType.Regular, 0x3B2,
                            1071921); // * The plague beast begins to bubble and dissolve! *
