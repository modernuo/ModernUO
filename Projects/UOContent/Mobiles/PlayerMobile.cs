        ...
        */
            ...
            try
            {
                ...
                for (int i = items.Count - 1; i >= 0; --i)
                {
                    ...
                    if (item is BaseWeapon weapon)
                    {
                        ...
                        if (drop)
                        {
                            from.SendLocalizedMessage(1062001,
                                weapon.Name ?? $"#{weapon.LabelNumber}"); // You can no longer wield your ~1_WEAPON~
                    ...
                    else if (item is BaseClothing clothing)
                    {
                        ...
                        if (drop)
                        {
                            from.SendLocalizedMessage(1062002,
                                clothing.Name ?? $"#{clothing.LabelNumber}"); // You can no longer wear your ~1_ARMOR~
        ...
        private class CancelRenewInventoryInsuranceGump : Gump
        {
                ...
                200)
            {
                ...
                AddHtmlLocalized(8, 8, 228, 100, 1071021,
                    0x7FFF); // You are about to disable inventory insurance auto-renewal.
