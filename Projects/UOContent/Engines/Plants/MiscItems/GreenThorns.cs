...
public partial class GreenThorns : Item
{
    [Constructible]
    ...
    {
        private readonly GreenThorns _thorn;

        public InternalTarget(GreenThorns thorn) : base(3, true, TargetFlags.None) => _thorn = thorn;
        ...
        protected override void OnTarget(Mobile from, object targeted)
        {
            ...
            if (!_thorn.IsChildOf(from.Backpack))
            {
                from.SendLocalizedMessage(1042664); // You must have the object in your backpack to use it.
                return;
            }
...
[SerializationGenerator(0, false)]
public partial class GreenThornsSHTeleporter : Item
{
    private static readonly Point3D Destination = new(5738, 1856, 0);
