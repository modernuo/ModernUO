...
namespace Server.Engines.MLQuests.Definitions
{
    ...
    public class Spirits : MLQuest
    {
        public Spirits()
        {
            ...
            Objectives.Add(new KillObjective(15, new[] { typeof(Spectre), typeof(Shade), typeof(Wraith) },
    ...
    public class UnholyKnights : MLQuest
    {
        public UnholyKnights()
        {
            ...
            Objectives.Add(new KillObjective(16, new[] { typeof(BoneKnight), typeof(SkeletalKnight) },
    ...
    public class ForkedTongue : MLQuest
    {
        public ForkedTongue()
        {
            ...
            Objectives.Add(new KillObjective(10, new[] { typeof(OphidianKnight) },
    ...
    public class UndeadMages : MLQuest
    {
        public UndeadMages()
        {
            ...
            Objectives.Add(new KillObjective(10, new[] { typeof(BoneMagi), typeof(SkeletalMage) },
    ...
    public class ParoxysmusSuccubi : MLQuest
    {
        public ParoxysmusSuccubi()
        {
            ...
            Objectives.Add(new KillObjective(3, new[] { typeof(Succubus) }, "succubi",
                new QuestArea(1074806, "The Palace of Paroxysmus"))); // The Palace of Paroxysmus
    ...
    public class ParoxysmusMoloch : MLQuest
    {
        public ParoxysmusMoloch()
        {
            ...
            Objectives.Add(new KillObjective(3, new[] { typeof(Moloch) }, "molochs",
                new QuestArea(1074806, "The Palace of Paroxysmus"))); // The Palace of Paroxysmus
    ...
    public class ParoxysmusDaemons : MLQuest
    {
        public ParoxysmusDaemons()
        {
            ...
            Objectives.Add(new KillObjective(10, new[] { typeof(Daemon) }, "daemons",
                new QuestArea(1074806, "The Palace of Paroxysmus"))); // The Palace of Paroxysmus
    ...
    public class ParoxysmusArcaneDaemons : MLQuest
    {
        public ParoxysmusArcaneDaemons()
        {
            ...
            Objectives.Add(new KillObjective(10, new[] { typeof(ArcaneDaemon) }, "arcane daemons",
                new QuestArea(1074806, "The Palace of Paroxysmus"))); // The Palace of Paroxysmus
    ...
    public class CausticCombo : MLQuest
    {
        public CausticCombo()
        {
            ...
            Objectives.Add(new KillObjective(3, new[] { typeof(PoisonElemental) }, "poison elementals",
                new QuestArea(1074806, "The Palace of Paroxysmus"))); // The Palace of Paroxysmus
            Objectives.Add(new KillObjective(6, new[] { typeof(AcidElemental) }, "acid elementals",
                new QuestArea(1074806, "The Palace of Paroxysmus"))); // The Palace of Paroxysmus
    ...
    public class PlagueLord : MLQuest
    {
        public PlagueLord()
        {
            ...
            Objectives.Add(new KillObjective(10, new[] { typeof(PlagueSpawn) }, "plague spawns",
                new QuestArea(1074806, "The Palace of Paroxysmus"))); // The Palace of Paroxysmus
            Objectives.Add(new KillObjective(3, new[] { typeof(PlagueBeast) }, "plague beasts",
                new QuestArea(1074806, "The Palace of Paroxysmus"))); // The Palace of Paroxysmus
            Objectives.Add(new KillObjective(1, new[] { typeof(PlagueBeastLord) }, "plague beast lord",
                new QuestArea(1074806, "The Palace of Paroxysmus"))); // The Palace of Paroxysmus
    ...
    public class GlassyFoe : MLQuest
    {
        public GlassyFoe()
        {
            ...
            Objectives.Add(new KillObjective(5, new[] { typeof(CrystalLatticeSeeker) }, "crystal lattice seekers",
                new QuestArea(1074805, "The Prism of Light"))); // The Prism of Light
    ...
    public class DaemonicPrism : MLQuest
    {
        public DaemonicPrism()
        {
            ...
            Objectives.Add(new KillObjective(3, new[] { typeof(CrystalDaemon) }, "crystal daemons",
                new QuestArea(1074805, "The Prism of Light"))); // The Prism of Light
    ...
    public class Hailstorm : MLQuest
    {
        public Hailstorm()
        {
            ...
            Objectives.Add(new KillObjective(8, new[] { typeof(CrystalVortex) }, "crystal vortices",
                new QuestArea(1074805, "The Prism of Light"))); // The Prism of Light
    ...
    */
    ...
    public class DeathToTheNinja : MLQuest
    {
        public DeathToTheNinja()
        {
            ...
            Objectives.Add(new KillObjective(10, new[] { typeof(EliteNinja) }, "elite ninjas",
                new QuestArea(1074804, "The Citadel"))); // The Citadel
