...
namespace Server.Engines.MLQuests.Definitions
{
    ...
    public class ADishBestServedCold : MLQuest
    {
        public ADishBestServedCold()
        {
            ...
            Objectives.Add(new KillObjective(10, new[] { typeof(Orc) }, "orcs",
                new QuestArea(1074807, "Sanctuary"))); // Sanctuary
            Objectives.Add(new KillObjective(5, new[] { typeof(OrcBomber) }, "orc bombers",
                new QuestArea(1074807, "Sanctuary"))); // Sanctuary
            Objectives.Add(new KillObjective(3, new[] { typeof(OrcBrute) }, "orc brutes",
                new QuestArea(1074807, "Sanctuary"))); // Sanctuary
    ...
    public class MougGuurMustDie : MLQuest
    {
        public MougGuurMustDie()
        {
            ...
            Objectives.Add(
                new KillObjective(1, new[] { typeof(MougGuur) }, "Moug-Guur",
                    new QuestArea(1074807, "Sanctuary"))); // Sanctuary
    ...
    public class LeaderOfThePack : MLQuest
    {
        public LeaderOfThePack()
        {
            ...
            Objectives.Add(new KillObjective(1, new[] { typeof(Chiikkaha) }, "Chiikkaha",
                new QuestArea(1074807, "Sanctuary"))); // Sanctuary
    ...
    public class SayonaraSzavetra : MLQuest
    {
        public SayonaraSzavetra()
        {
            ...
            Objectives.Add(new KillObjective(1, new[] { typeof(Szavetra) }, "Szavetra",
                new QuestArea(1074807, "Sanctuary"))); // Sanctuary
    ...
    public class Marauders : MLQuest
    {
        public Marauders()
        {
            ...
            Objectives.Add(new KillObjective(10, new[] { typeof(Ogre) }, "ogres",
                new QuestArea(1074807, "Sanctuary"))); // Sanctuary
    ...
    public class TheBrainsOfTheOperation : MLQuest
    {
        public TheBrainsOfTheOperation()
        {
            ...
            Objectives.Add(new KillObjective(10, new[] { typeof(OgreLord) }, "ogre lords",
                new QuestArea(1074807, "Sanctuary"))); // Sanctuary
    ...
    public class TheBrawn : MLQuest
    {
        public TheBrawn()
        {
            ...
            Objectives.Add(new KillObjective(6, new[] { typeof(Cyclops) }, "cyclops",
                new QuestArea(1074807, "Sanctuary"))); // Sanctuary
    ...
    public class TheBiggerTheyAre : MLQuest
    {
        public TheBiggerTheyAre()
        {
            ...
            Objectives.Add(new KillObjective(3, new[] { typeof(Titan) }, "titans",
                new QuestArea(1074807, "Sanctuary"))); // Sanctuary
    ...
    public class TroubleOnTheWing : MLQuest
    {
        public TroubleOnTheWing()
        {
            ...
            Objectives.Add(new KillObjective(12, new[] { typeof(Gargoyle) }, "gargoyles",
                new QuestArea(1074807, "Sanctuary"))); // Sanctuary
