...
namespace Server.Engines.MLQuests.Gumps
{
    ...
    public abstract class BaseQuestGump : Gump
    {
        ...
        {
            AddHtmlLocalized(98, 140, 312, 16, quest.IsChainTriggered || quest.NextQuest != null ? 1075024 : 1072202,
                0x2710); // Description [(quest chain)]
        ...
        public void AddObjectives(MLQuest quest)
        {
            ...
            AddHtmlLocalized(98, 156, 312, 16, quest.ObjectiveType == ObjectiveType.All ? 1072208 : 1072209,
                0x2710); // All of the following / Only one of the following
