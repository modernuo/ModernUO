...
namespace Server.Engines.Quests
{
    ...
    public class QuestCancelGump : BaseQuestGump
    {
        ...
        public QuestCancelGump(QuestSystem system) : base(120, 50)
        {
            ...
            {
                AddHtmlLocalized(25, 55, 300, 120, 1060836,
                    White); // This quest will give you valuable information, skills and equipment that will help you advance in the game at a quicker pace.<BR><BR>Are you certain you wish to cancel at this time?
            }
            else
            {
                ...
                AddHtmlLocalized(48, 140, 280, 20, system.RestartDelay < TimeSpan.MaxValue ? 1049016 : 1049017,
                    DarkGreen); // Yes/No
            }
