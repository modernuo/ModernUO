    ...
    public class CraftGumpItem : Gump
    {
        ...
        public CraftGumpItem(Mobile from, CraftSystem craftSystem, CraftItem craftItem, BaseTool tool) : base(40, 40)
        {
            ...
            if (craftItem.UseAllRes)
                AddHtmlLocalized(170, 302 + m_OtherCount++ * 20, 310, 18, 1048176,
                    LabelColor); // Makes as many as possible at once
            ...
            if (needsRecipe)
                AddHtmlLocalized(170, 302 + m_OtherCount++ * 20, 310, 18, 1073620,
                    RedLabelColor); // You have not learned this recipe.
        }
        ...
        public void DrawItem()
        {
            ...
            {
                AddHtmlLocalized(170, 302 + m_OtherCount++ * 20, 310, 18, 1044059,
                    LabelColor); // This item may hold its maker's mark
        ...
        public void DrawResource()
        {
            ...
            for (int i = 0; i < m_CraftItem.Resources.Count - (cropScroll ? 1 : 0) && i < 4; i++)
            {
                ...
                {
                    retainedColor = true;
                    AddHtmlLocalized(170, 302 + m_OtherCount++ * 20, 310, 18, 1044152,
                        LabelColor); // * The item retains the color of this material
            ...
            if (cropScroll)
                AddHtmlLocalized(170, 302 + m_OtherCount++ * 20, 360, 18, 1044379,
                    LabelColor); // Inscribing scrolls also requires a blank scroll and mana.
        }
