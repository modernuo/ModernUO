...
public static class Repair
{
    ...
    private class InternalTarget : Target
    {
        ...
        private bool IsSpecialClothing( BaseClothing clothing )
        {
            ...
            {
                return clothing is BearMask or DeerMask or TheMostKnowledgePerson or TheRobeOfBritanniaAri
                    or EmbroideredOakLeafCloak;
            }
        ...
        private bool IsSpecialWeapon( BaseWeapon weapon )
        {
            ...
            {
                return weapon is Pitchfork or RadiantScimitar or WarCleaver or ElvenSpellblade or AssassinSpike or Leafblade
                    or RuneBlade or ElvenMachete or OrnateAxe or DiamondMace;
            }
        ...
        private bool IsSpecialArmor( BaseArmor armor )
        {
            ...
            if ( m_CraftSystem is DefTailoring )
            {
                return armor is LeafTonlet or LeafArms or LeafChest or LeafGloves or LeafGorget or LeafLegs or HideChest
                    or HideGloves or HideGorget or HidePants or HidePauldrons;
            }

            if ( m_CraftSystem is DefCarpentry )
            {
                return armor is WingedHelm or RavenHelm or VultureHelm or WoodlandArms or WoodlandChest or WoodlandGloves
                    or WoodlandGorget or WoodlandLegs;
            }
