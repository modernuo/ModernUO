...
public class DefTailoring : CraftSystem
{
    ...
    public override bool RetainsColorFrom( CraftItem item, Type type )
    {
        ...
        for ( var i = 0; !contains && i < tailorColorables.Length; ++i )
        {
            contains = tailorColorables[i] == type;
        }
    ...
    public override void InitCraftList()
    {
        ...
        index = AddCraft(
            typeof( LeatherContainerEngraver ),
            1015283,
            1072152,
            65.0,
            115.0,
        ...
        {
            index = AddCraft(
                typeof( GargishLeatherArmsType1 ),
                1015293,
                1020769,
                53.9,
                78.9,
            ...
            index = AddCraft(
                typeof( GargishLeatherArmsType2 ),
                1015293,
                1020770,
                53.9,
                78.9,
            ...
            index = AddCraft(
                typeof( GargishLeatherKiltType1 ),
                1015293,
                1020784,
                58.0,
                83.0,
            ...
            index = AddCraft(
                typeof( GargishLeatherKiltType2 ),
                1015293,
                1020785,
                58.0,
                83.0,
            ...
            index = AddCraft(
                typeof( GargishLeatherLegsType1 ),
                1015293,
                1020773,
                66.3,
                91.3,
            ...
            index = AddCraft(
                typeof( GargishLeatherLegsType2 ),
                1015293,
                1020774,
                66.3,
                91.3,
            ...
            index = AddCraft(
                typeof( GargishLeatherChestType1 ),
                1015293,
                1020772,
                70.5,
                95.5,
            ...
            index = AddCraft(
                typeof( GargishLeatherChestType2 ),
                1015293,
                1020771,
                70.5,
                95.5,
        ...
        {
            index = AddCraft(
                typeof( GargishStuddedArmsType1 ),
                1015300,
                1020643,
                87.1,
                112.1,
            ...
            index = AddCraft(
                typeof( GargishStuddedArmsType2 ),
                1015300,
                1020644,
                87.1,
                112.1,
            ...
            index = AddCraft(
                typeof( GargishStuddedKiltType1 ),
                1015300,
                1020647,
                89.5,
                114.5,
            ...
            index = AddCraft(
                typeof( GargishStuddedKiltType2 ),
                1015300,
                1020648,
                89.5,
                114.5,
            ...
            index = AddCraft(
                typeof( GargishStuddedLegsType1 ),
                1015300,
                1020649,
                91.2,
                116.2,
            ...
            index = AddCraft(
                typeof( GargishStuddedLegsType2 ),
                1015300,
                1020650,
                91.2,
                116.2,
            ...
            index = AddCraft(
                typeof( GargishStuddedChestType1 ),
                1015300,
                1020645,
                94.0,
                119.0,
            ...
            index = AddCraft(
                typeof( GargishStuddedChestType2 ),
                1015300,
                1020646,
                94.0,
                119.0,
