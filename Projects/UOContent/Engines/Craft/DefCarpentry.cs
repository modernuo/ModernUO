...
public class DefCarpentry : CraftSystem
{
    ...
    public override void InitCraftList()
    {
        ...
        if ( Core.ML )
        {
            ...
            ForceNonExceptional( index );
            index = AddCraft(
                typeof( ElvenWashBasinSouthDeed ),
                1044292,
                1072865,
                70.0,
                95.0,
