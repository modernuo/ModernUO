...
namespace Server.Engines.Chat
{
    public static class ChatSystem
    {
        ...
        public static void OpenChatWindowRequest(NetState state, ref CircularBufferReader reader)
        {
        ...
        public static void ChatAction(NetState state, ref CircularBufferReader reader)
        {
            if (!Enabled)
            {
                return;
