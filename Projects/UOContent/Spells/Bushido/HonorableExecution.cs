...
namespace Server.Spells.Bushido
{
    public class HonorableExecution : SamuraiMove
    {
        ...
        public static int GetSwingBonus(Mobile target) =>
            m_Table.TryGetValue(target, out HonorableExecutionInfo info) ? info.m_SwingBonus : 0;

        public static bool IsUnderPenalty(Mobile target) =>
            m_Table.TryGetValue(target, out HonorableExecutionInfo info) && info.m_Penalty;
