...
namespace Server.Spells
{
    ...
    public class SpellHelper
    {
        ...
        public static bool AddStatBonus(Mobile caster, Mobile target, StatType type) => AddStatBonus(caster, target, type,
            GetOffset(caster, target, type, false), GetDuration(caster, target));
        ...
        public static bool AddStatCurse(Mobile caster, Mobile target, StatType type) => AddStatCurse(caster, target, type,
            GetOffset(caster, target, type, true), GetDuration(caster, target));
        ...
        {
            Damage(spell, GetDamageDelayForSpell(spell), target, spell.Caster, damage, phys, fire, cold, pois, nrgy, chaos,
                dfa);
        }
        ...
        private class SpellDamageTimerAOS : Timer
        {
            ...
            public SpellDamageTimerAOS(Spell s, TimeSpan delay, Mobile target, Mobile from, int damage, int phys, int fire,
                int cold,
