    ...
    public abstract class StValentinesBear : Item
    {
        ...
        private class InternalGump : Gump
        {
                ...
                : base(50, 50)
            {
                ...
                AddHtmlLocalized(10, 40, 400, 75, 1150293,
                    0); // Enter up to three lines of personalized greeting for your St. Valentine Bear. You many enter up to 25 characters per line. Once you enter text, you will only be able to correct mistakes for 10 minutes.
