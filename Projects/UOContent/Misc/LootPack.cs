...
namespace Server
{
    public class LootPack
    {
        ...
        public static readonly LootPack ArcanistScrolls = new( [new LootPackEntry( false, ArcanistScrollItems, 100.0, 1 )] );
        ...
        public static readonly LootPack PeerlessResource = new( [new LootPackEntry(false, PeerlessResourceItems, 100.00, 1)] );
        public static readonly LootPack Talisman = new( [new LootPackEntry( false, [new LootPackItem( typeof( RandomTalisman ), 1 )], 100.00, 1 )] );

        public static LootPack LootItem<T>() where T : Item => new( [new LootPackEntry(false, [new LootPackItem(typeof(T), 1)], 100.0, 1)] );
        public static LootPack LootItem<T>(double chance) where T : Item => new( [new LootPackEntry(false, [new LootPackItem(typeof(T), 1)], chance, 1)] );

        private readonly LootPackEntry[] m_Entries;

        public LootPack( LootPackEntry[] entries ) => m_Entries = entries;

        public static LootPack RandomLootItem(Type[] types) => RandomLootItem(types, 100.0, 1, false, false);
        public static LootPack RandomLootItem(Type[] types, bool onSpawn, bool onSteal) => RandomLootItem(types, 100.0, 1, onSpawn, onSteal);
        public static LootPack RandomLootItem(Type[] types, double chance, int amount) => RandomLootItem(types, chance, amount, false, false);
        ...
        public static LootPack RandomLootItem(Type[] types, double chance, int amount, bool onSpawn, bool onSteal)
        {
            ...
            return new LootPack( [new LootPackEntry(onSpawn, items, chance, amount)] );
        }
        ...
        public static readonly LootPack Parrot = new(
            [
                new LootPackEntry( false, [new LootPackItem( typeof( ParrotItem ), 10 )], 10.0, 1 )
            ]
        );
        ...
        public class LootPackItem
        {
            ...
            [
                // Low
                [
                    typeof( AnimateDeadScroll ), typeof( BloodOathScroll ), typeof( CorpseSkinScroll ),
                    typeof( CurseWeaponScroll ),
                    typeof( EvilOmenScroll ), typeof( HorrificBeastScroll ), typeof( MindRotScroll ),
