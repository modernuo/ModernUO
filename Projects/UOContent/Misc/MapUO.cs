...
namespace Server.Misc
{
    public static class MapUO
    {
        ...
        private static void OnPartyTrack(NetState state, ref CircularBufferReader reader)
        {
        ...
        private static void OnGuildTrack(NetState state, ref CircularBufferReader reader)
        {
            var from = state.Mobile;
