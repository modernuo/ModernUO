...
namespace Server.Multis
{
    ...
    public abstract class BaseBoat : BaseMulti
    {
        ...
        public void UpdateComponents()
        {
            ...
            if (TillerMan != null)
            {
                TillerMan.Location = new Point3D(X + xOffset * TillerManDistance + (m_Facing == Direction.North ? 1 : 0),
        ...
        public bool StartCourse(string navPoint, bool single, bool message)
        {
            ...
            if (start != -1)
            {
                ...
                if (number != -1)
                {
                    ...
                    if (MapItem == null || number < 0 || number >= MapItem.Pins.Count) number = -1;
                }
            }
        ...
        public static Rectangle2D[] GetWrapFor(Map m) =>
            m == Map.Ilshenar ? m_IlshWrap : m == Map.Tokuno ? m_TokunoWrap : m_BritWrap;
        ...
        public List<IEntity> GetMovingEntities()
        {
            ...
            foreach (IEntity o in map.GetObjectsInBounds(
