...
namespace Server.Items
{
    ...
    public class HousePlacementEntry
    {
        ...
        public static HousePlacementEntry[] HousesEJ { get; } =
        {
            ...
            new HousePlacementEntry(typeof(GothicRoseCastle), 1158749, 4076, 2038, 4688, 2344, 78, 44808750, 0, 16, 0,
                0x147F),
            ...
            new HousePlacementEntry(typeof(CastleOfOceania), 1158760, 4076, 2038, 4688, 2344, 78, 48971250, 0, 16, 0,
                0x1482),
            ...
            new HousePlacementEntry(typeof(TraditionalKeep), 1158851, 2625, 1312, 3019, 1509, 52, 26685000, 0, 11, 0,
                0x1485),
            ...
            new HousePlacementEntry(typeof(LacrimaeInCaelo), 1158962, 4076, 2038, 4688, 2344, 78, 45315000, 0, 16, 0,
                0x148C),
            new HousePlacementEntry(typeof(OkinawaSweetDreamCastle), 1158963, 4076, 2038, 4688, 2344, 78, 40128750, 0, 16, 0,
                0x148D),
            new HousePlacementEntry(typeof(TheSandstoneCastle), 1158964, 4076, 2038, 4688, 2344, 78, 48690000, 0, 16, 0,
                0x148E),
            new HousePlacementEntry(typeof(GrimswindSisters), 1158965, 4076, 2038, 4688, 2344, 78, 42142500, 0, 16, 0,
                0x148F)
        };
                ...
                case HousePlacementResult.Valid:
                    {
                        ...
                        else
                        {
                             ...
                             */
                            from.SendGump(new WarningGump(1060635, 30720, 1049583, 32512, 420, 280,
