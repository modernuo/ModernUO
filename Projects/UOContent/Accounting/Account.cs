...
public partial class BaseAccount : IAccount, IComparable<BaseAccount>
{
    ...
    {
        if (m.Account is not BaseAccount acc)
        {
            return;
        }
    ...
    {
        private readonly BaseAccount m_Account;

        public YoungTimer(BaseAccount account)
...
public partial class Account : IAccount, IPasswordAccount, IComparable<Account>
{
    public static readonly TimeSpan YoungDuration = TimeSpan.FromHours(40.0);
    public static readonly TimeSpan InactiveDuration = TimeSpan.FromDays(180.0);
    public static readonly TimeSpan EmptyInactiveDuration = TimeSpan.FromDays(30.0);
