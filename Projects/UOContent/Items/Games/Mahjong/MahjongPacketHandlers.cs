...
{
    public delegate void OnMahjongPacketReceive(MahjongGame game, NetState state, ref CircularBufferReader reader);
    ...
    public sealed class MahjongPacketHandlers
    {
        ...
        public static void OnPacket(NetState state,ref CircularBufferReader reader)
        {
        ...
        public static void ExitGame(MahjongGame game, NetState state, ref CircularBufferReader reader)
        {
            if (game == null)
            {
                return;
        ...
        public static void GivePoints(MahjongGame game, NetState state, ref CircularBufferReader reader)
        {
        ...
        public static void RollDice(MahjongGame game, NetState state, ref CircularBufferReader reader)
        {
            if (game?.Players.IsInGamePlayer(state.Mobile) != true)
            {
                return;
        ...
        public static void BuildWalls(MahjongGame game, NetState state, ref CircularBufferReader reader)
        {
        ...
        public static void ResetScores(MahjongGame game, NetState state, ref CircularBufferReader reader)
        {
            if (game?.Players.IsInGameDealer(state.Mobile) != true)
            {
                return;
        ...
        public static void AssignDealer(MahjongGame game, NetState state, ref CircularBufferReader reader)
        {
            if (game?.Players.IsInGameDealer(state.Mobile) != true)
            {
                return;
        ...
        public static void OpenSeat(MahjongGame game, NetState state, ref CircularBufferReader reader)
        {
            if (game?.Players.IsInGameDealer(state.Mobile) != true)
            {
                return;
        ...
        public static void ChangeOption(MahjongGame game, NetState state, ref CircularBufferReader reader)
        {
            if (game?.Players.IsInGameDealer(state.Mobile) != true)
            {
                return;
        ...
        public static void MoveWallBreakIndicator(MahjongGame game, NetState state, ref CircularBufferReader reader)
        {
            if (game?.Players.IsInGameDealer(state.Mobile) != true)
            {
                return;
        ...
        public static void TogglePublicHand(MahjongGame game, NetState state, ref CircularBufferReader reader)
        {
            if (game?.Players.IsInGamePlayer(state.Mobile) != true)
            {
                return;
        ...
        public static void MoveTile(MahjongGame game, NetState state, ref CircularBufferReader reader)
        {
            if (game?.Players.IsInGamePlayer(state.Mobile) != true)
            {
                return;
        ...
        public static void MoveDealerIndicator(MahjongGame game, NetState state, ref CircularBufferReader reader)
        {
            if (game?.Players.IsInGameDealer(state.Mobile) != true)
            {
                return;
