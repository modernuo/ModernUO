    ...
    public class SoulStone : Item, ISecurable
    {
        ...
        protected virtual bool CheckUse(Mobile from)
        {
            ...
            if (Account != null && (!(from.Account is Account) || from.Account.Username != Account))
            {
                from.SendLocalizedMessage(
                    1070714); // This is an Account Bound Soulstone, and your character is not bound to it.  You cannot use this Soulstone.
                return false;
            }
            ...
            {
                from.SendLocalizedMessage(
                    1070727); // You must wait two minutes after engaging in combat before you can use a Soulstone.
                return false;
            }
            ...
            {
                from.SendLocalizedMessage(
                    1070728); // You must wait two minutes after committing a criminal act before you can use a Soulstone.
                return false;
            }
            ...
            {
                from.SendLocalizedMessage(
                    1070729); // In order to use your Soulstone, you must be in a safe log-out location.
                return false;
            }
            ...
            {
                from.SendLocalizedMessage(
                    1070731); // You may not use a Soulstone while your character has a faction town sigil.
                return false;
            }
        ...
        private class ConfirmSkillGump : Gump
        {
            ...
            public ConfirmSkillGump(SoulStone stone, Skill skill) : base(50, 50)
            {
                ...
                AddHtmlLocalized(45, 362, 450, 20, 1070720,
                    0x7FFF); // Activate the stone.  I am ready to transfer the skill points to it.
            ...
            public override void OnResponse(NetState sender, RelayInfo info)
            {
                ...
                Effects.SendLocationParticles(EffectItem.Create(from.Location, from.Map, EffectItem.DefaultDuration), 0, 0,
                    0, 0, 0, 5060, 0);
                Effects.PlaySound(from.Location, from.Map, 0x243);

                Effects.SendMovingParticles(
                    new Entity(Server.Serial.Zero, new Point3D(from.X - 6, from.Y - 6, from.Z + 15), from.Map), from, 0x36D4,
                    7, 0, false, true, 0x497, 0, 9502, 1, 0, (EffectLayer)255, 0x100);
        ...
        private class ConfirmTransferGump : Gump
        {
            ...
            public ConfirmTransferGump(SoulStone stone, Mobile from) : base(50, 50)
            {
                ...
                AddButton(10, 360, 0xFA5, 0xFA6, 2);
                AddHtmlLocalized(45, 362, 450, 20, 1070719,
                    0x7FFF); // Activate the stone.  I am ready to retrieve the skill points from it.

                AddButton(10, 380, 0xFA5, 0xFA6, 1);
                AddHtmlLocalized(45, 382, 450, 20, 1070723,
                    0x7FFF); // Remove all skill points from this stone and DO NOT absorb them.
