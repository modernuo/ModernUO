    ...
    public class HouseLadderDeed : BaseAddonDeed
    {
        ...
        private class InternalGump : Gump
        {
            ...
            public InternalGump(HouseLadderDeed deed) : base(60, 36)
            {
                ...
                AddHtmlLocalized(14, 12, 273, 20, 1076780,
                    0x7FFF); // Please select your ladder position.  <br>Use the ladders marked (castle) <br> for accessing the tops of keeps <br> and castles.
