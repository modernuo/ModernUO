  ...
  public class HouseRaffleStone : Item
  {
    ...
    public static string FormatLocation(Point3D loc, Map map, bool displayMap)
    {
      ...
      if (Sextant.Format(loc, map, ref xLong, ref yLat, ref xMins, ref yMins, ref xEast, ref ySouth))
        result.AppendFormat("{0}°{1}'{2},{3}°{4}'{5}", yLat, yMins, ySouth ? "S" : "N", xLong, xMins,
          xEast ? "E" : "W");
      else
    ...
    public void CheckEnd()
    {
      ...
      if (m_Region != null && Entries.Count != 0)
      {
        ...
        if (m_Winner != null)
        {
          ...
          m_Winner.SendMessage(MessageHue,
            "Congratulations, {0}!  You have won the raffle for the plot located at {1}.", m_Winner.Name,
            FormatLocation());
