    ...
    public class PlagueBeastInnard : Item, IScissorable, ICarvable
    {
        ...
        public override bool IsAccessibleTo(Mobile check)
        {
            ...
            if (!owner.InRange(check, 2))
                ...
                owner.PrivateOverheadMessage(MessageType.Label, 0x3B2, 500365,
    ...
    public class PlagueBeastComponent : PlagueBeastInnard
    {
        ...
        public override bool OnDragLift(Mobile from)
        {
            if (IsAccessibleTo(from))
            {
                ...
                {
                    from.SendLocalizedMessage(IsGland ? 1071895 : 1071914,
                        null); // * You rip the organ out of the plague beast's flesh *
