    ...
    public class PowerScroll : SpecialScroll
    {
        ...
        */
        ...
        public override bool CanUse(Mobile from)
        {
            ...
            if (skill.Cap >= Value)
            {
                from.SendLocalizedMessage(1049511,
                    GetNameLocalized()); // Your ~1_type~ is too high for this power scroll.
                return false;
            }
        ...
        public override void Use(Mobile from)
        {
            ...
            Effects.SendLocationParticles(EffectItem.Create(from.Location, from.Map, EffectItem.DefaultDuration), 0,
                0, 0, 0,
                0, 5060, 0);
