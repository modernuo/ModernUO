  ...
  public class CannonAddon : BaseAddon
  {
          ...
          if (from.Backpack != null)
          {
            ...
            if (Validate(keg) > 0)
              ...
              from.SendLocalizedMessage(
                1076198); // You do not have a full keg of explosion potions needed to recharge the cannon.
          }
        }
      }
      else
    ...
    private class InternalGump : Gump
    {
      ...
      public InternalGump(CannonAddon cannon, PotionKeg keg) : base(50, 50)
      {
        ...
        AddHtmlLocalized(9, 9, 272, 100, 1076196, cannon.Validate(keg).ToString(), 0x7FFF); // You will need a full keg of explosion potions to recharge the cannon.  Your keg will provide ~1_CHARGES~ charges.
