...
public class CrystalPortalGump : Gump
{
    ...
    public CrystalPortalGump( Mobile from )
        : base( 245, 200 )
    {
        from.CloseGump<CrystalPortalGump>();

        AddImage( 0, 0, 0x1FE );
        AddPage( 1 );
        AddHtmlLocalized( 40, 30, 150, 48, 1113945, 0 );   // Crystal Portal
        AddHtmlLocalized( 40, 160, 150, 16, 1113300, 0 );  // by
        AddHtmlLocalized( 40, 180, 150, 32, 1113299, 0 );  // <center>(unknown)</center>
        AddHtmlLocalized( 230, 30, 145, 160, 1113946, 0 ); // This crystal portal allows you to teleport directly to a bank
        ...
        AddHtmlLocalized(
            ...
            1113947,
            0
        ); // moongate, say the gate's name and "moongate" (eg. "minoc moongate").
        ...
        AddHtmlLocalized(
            ...
            1113948,
            0
        ); // CITY NAMES:<br>britain, bucs, cove, delucia, haven, jhelom, magincia, minoc, 
        ...
        AddHtmlLocalized(
            ...
            1113949,
            0
        ); // MOONGATE NAMES<br>moonglow, britain, jhelom, yew, minoc, trinsic, skara,
        ...
        AddHtmlLocalized(
            ...
            1113950,
            0
        ); // luna, umbra, isamu, makoto, homare, termur, eodon<br><br><br>The same teleportation 
