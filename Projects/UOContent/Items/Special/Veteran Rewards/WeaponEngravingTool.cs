            ...
            public ConfirmGump(WeaponEngravingTool engraver, Mobile guildmaster) : base(200, 200)
            {
                ...
                if (guildmaster != null)
                {
                    AddHtmlLocalized(9, 9, 272, 100, 1076169,
                        0x7FFF); // It will cost you 100,000 gold and a blue diamond to recharge your weapon engraver with 10 charges.
                    AddHtmlLocalized(195, 109, 120, 20, 1076172, 0x7FFF); // Recharge it
                }
                else
                {
                    AddHtmlLocalized(9, 9, 272, 100, 1076176,
                        0x7FFF); // You will need a blue diamond to repair the tip of the engraver.  A successful repair will give the engraver 10 charges.
