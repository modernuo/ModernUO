...
namespace Server
{
    ...
    public static class SetHelper
    {
        public static void GetSetProperties( IPropertyList list, ISetItem setItem )
        {
            ...
            {
                list.Add(
                    full ? 1080244 : 1154369,
                    ( full ? prop + attrs.RegenHits * pieces : prop ).ToString()
            ...
            {
                list.Add(
                    full ? 1080245 : 1080250,
                    ( full ? prop + attrs.RegenMana * pieces : prop ).ToString()
            ...
            {
                list.Add(
                    full ? 1073493 : 1060408,
                    ( full ? prop + attrs.DefendChance * pieces : prop ).ToString()
            ...
            {
                list.Add(
                    full ? 1073490 : 1154366,
                    ( full ? prop + attrs.AttackChance * pieces : prop ).ToString()
            ...
            {
                list.Add(
                    full ? 1072514 : 1060485,
                    ( full ? prop + attrs.BonusStr * pieces : prop ).ToString()
            ...
            {
                list.Add(
                    full ? 1072503 : 1080447,
                    ( full ? prop + attrs.BonusDex * pieces : prop ).ToString()
            ...
            {
                list.Add(
                    full ? 1072381 : 1080439,
                    ( full ? prop + attrs.BonusInt * pieces : prop ).ToString()
            ...
            {
                list.Add(
                    full ? 1080360 : 1080358,
                    ( full ? prop + attrs.BonusHits * pieces : prop ).ToString()
            ...
            {
                list.Add(
                    full ? 1060484 : 1060484,
                    ( full ? prop + attrs.BonusStam * pieces : prop ).ToString()
            ...
            {
                list.Add(
                    full ? 1060439 : 1060439,
                    ( full ? prop + attrs.BonusMana * pieces : prop ).ToString()
            ...
            {
                list.Add(
                    full ? 1151216 : 1154367,
                    ( full ? prop + attrs.WeaponDamage * pieces : prop ).ToString()
            ...
            {
                list.Add(
                    full ? 1074323 : 1154368,
                    ( full ? prop + attrs.WeaponSpeed * pieces : prop ).ToString()
            ...
            {
                list.Add(
                    full ? 1072380 : 1060483,
                    ( full ? prop + attrs.SpellDamage * pieces : prop ).ToString()
            ...
            {
                list.Add(
                    full ? 1080242 : 1080248,
                    ( full ? prop + attrs.CastRecovery * pieces : prop ).ToString()
            ...
            {
                list.Add(
                    full ? 1080243 : 1080247,
                    ( full ? prop + attrs.CastSpeed * pieces : prop ).ToString()
            ...
            {
                list.Add(
                    full ? 1073488 : 1060433,
                    ( full ? prop + attrs.LowerManaCost * pieces : prop ).ToString()
            ...
            {
                list.Add(
                    full ? 1080441 : 1080440,
                    ( full ? prop + attrs.LowerRegCost * pieces : prop ).ToString()
            ...
            {
                list.Add(
                    full ? 1072513 : 1060442,
                    ( prop + attrs.ReflectPhysical ).ToString()
            ...
            {
                list.Add(
                    full ? 1073489 : 1080246,
                    ( full ? prop + attrs.Luck * pieces : prop ).ToString()
                ); // luck ~1_val~% (total)
            }
            ...
            if ( setItem.SetSkillBonuses.Skill_1_Value != 0 )
            {
                list.Add(
                    1072502,
                    $"{"#" + ( 1044060 + ( int )setItem.SetSkillBonuses.Skill_1_Name )}\t{setItem.SetSkillBonuses.Skill_1_Value}"
                ); // ~1_skill~ ~2_val~ (total)
            }
        }
