...
namespace Server.Items
{
    ...
    public class BaseBook : Item, ISecurable
    {
        ...
        public static void OldHeaderChange(NetState state, ref CircularBufferReader reader)
        {
        ...
        public static void HeaderChange(NetState state, ref CircularBufferReader reader)
        {
            var from = state.Mobile;
        ...
        public static void ContentChange(NetState state, ref CircularBufferReader reader)
        {
            var from = state.Mobile;
