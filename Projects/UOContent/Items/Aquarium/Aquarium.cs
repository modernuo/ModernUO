  ...
  public class Aquarium : BaseAddonContainer
  {
    ...
    public override bool OnDragDrop(Mobile from, Item dropped)
    {
      ...
      else if (dropped is VacationWafer)
      {
        ...
        from.SendLocalizedMessage(1074428,
          m_VacationLeft.ToString()); // The aquarium will be in vacation mode for ~1_DAYS~ days
      }
    ...
    public override void OnSingleClick(Mobile from)
    {
      ...
      if (m_Food.State == (int)FoodState.Dead)
        ...
        LabelTo(from, 1074253,
          $"{m_Food.Added}\t{m_Food.Maintain}\t{m_Food.Improve}"); // Food Added: ~1_CUR~ Feed: ~2_NEED~ Improve: ~3_GROW~
      ...
      if (m_Water.State == (int)WaterState.Dead)
        ...
        LabelTo(from, 1074254,
          $"{m_Water.Added}\t{m_Water.Maintain}\t{m_Water.Improve}"); // Water Added: ~1_CUR~ Maintain: ~2_NEED~ Improve: ~3_GROW~
    }
    ...
    public override void AddNameProperties(ObjectPropertyList list)
    {
      ...
      if (m_Food.State == (int)FoodState.Dead)
        ...
        list.Add(1074253, "{0}\t{1}\t{2}", m_Food.Added, m_Food.Maintain,
          m_Food.Improve); // Food Added: ~1_CUR~ Feed: ~2_NEED~ Improve: ~3_GROW~
      ...
      if (m_Water.State == (int)WaterState.Dead)
        ...
        list.Add(1074254, "{0}\t{1}\t{2}", m_Water.Added, m_Water.Maintain,
          m_Water.Improve); // Water Added: ~1_CUR~ Maintain: ~2_NEED~ Improve: ~3_GROW~
    }
    ...
    public virtual bool AddFish(Mobile from, BaseFish fish)
    {
      ...
      from?.SendLocalizedMessage(1073632,
        $"#{fish.LabelNumber}"); // You add the following creature to your aquarium: ~1_FISH~
    ...
    public virtual bool AddDecoration(Mobile from, Item item)
    {
      ...
      from?.SendLocalizedMessage(1073635,
        item.LabelNumber != 0
          ? $"#{item.LabelNumber}"
          : item.Name); // You add the following decoration to your aquarium: ~1_NAME~
