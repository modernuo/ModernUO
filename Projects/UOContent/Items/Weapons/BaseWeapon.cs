...
namespace Server.Items
{
    ...
    public abstract class BaseWeapon : Item, IWeapon, IFactionItem, ICraftable, ISlayer, IDurability
    {
        ...
        public virtual int GetPackInstinctBonus(Mobile attacker, Mobile defender)
        {
            ...
            int inPack = 1 + eable.Where(m =>
                    m != attacker && (m.PackInstinct & bc.PackInstinct) != 0 && (m.Controlled || m.Summoned))
        ...
        public virtual void OnHit(Mobile attacker, Mobile defender, double damageBonus = 1.0)
        {
            ...
            GetDamageTypes(attacker, out int phys, out int fire, out int cold, out int pois, out int nrgy, out int chaos,
                out int direct);
