    ...
    public class TurboSlot : Item
    {
                    ...
                    case 0: // Fire column
                        {
                            ...
                            Effects.PlaySound(g.Location, g.Map, 0x208);
                            break;
                        }
                    case 1: // Explosion
                        {
                            Effects.SendLocationParticles(EffectItem.Create(g.Location, g.Map, EffectItem.DefaultDuration), 0x36BD, 20, 10, 5044);
                            Effects.PlaySound(g.Location, g.Map, 0x307);
        ...
        private void SlotOffline(int error)
        {
            ...
            if (this.m_InUseBy != null && this.m_InUseBy.Map != Map.Internal)
            {
                try
                {
                    this.m_InUseBy.CloseGump<NewMinerBonusGump>();
                    this.m_InUseBy.CloseGump<TurboSlotPayTableGump>();
