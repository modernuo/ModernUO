...
namespace Scripts.Mythik.Systems.Achievements
{
    ...
    public class AchievementSystem
    {
        ...
        public static void Initialize()
        {
            ...
            Achievements.Add(new DiscoveryAchievement(25, 3, 0x14EB, false, null, "Covetous!", "Discover the dungeon of Covetous", 10, "Covetous"));
            Achievements.Add(new DiscoveryAchievement(26, 3, 0x14EB, false, null, "Deceit!", "Discover the dungeon of Deceit", 10, "Deceit"));
            Achievements.Add(new DiscoveryAchievement(27, 3, 0x14EB, false, null, "Despise!", "Discover the dungeon of Despise", 10, "Despise"));
            Achievements.Add(new DiscoveryAchievement(28, 3, 0x14EB, false, null, "Destard!", "Discover the dungeon of Destard", 10, "Destard"));
            Achievements.Add(new DiscoveryAchievement(29, 3, 0x14EB, false, null, "Hythloth!", "Discover the dungeon of Hythloth", 10, "Hythloth"));
            Achievements.Add(new DiscoveryAchievement(30, 3, 0x14EB, false, null, "Wrong!", "Discover the dungeon of Wrong", 10, "Wrong"));
            Achievements.Add(new DiscoveryAchievement(31, 3, 0x14EB, false, null, "Shame!", "Discover the dungeon of Shame", 10, "Shame"));
            ...
            var slay5dog = new HunterAchievement(1000, 3000, 0x25D1, false, null, 5, "Dog Slayer", "Slay 5 Dogs", 5, typeof(Dog));
            var slay50dragon = new HunterAchievement(1001, 3000, 0x25D1, false, null, 50, "Dragon Slayer", "Slay 50 Dragon", 50, typeof(Dragon));
            var slay150dragon = new HunterAchievement(1002, 3000, 0x25D1, false, slay50dragon, 150, "Master Dragon Slayer", "Slay 150 Dragon", 60, typeof(Dragon));
            var slay400dragon = new HunterAchievement(1003, 3000, 0x25D1, false, slay150dragon, 400, "Dragon Exterminator", "Slay 400 Dragon", 180, typeof(Dragon));
