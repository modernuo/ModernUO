...
namespace Server
{
    public class SkilllimPickGump : Gump
	{
        ...
        private SkillBallLimited  m_SkillBall;
        private double val = 100;


		public SkilllimPickGump( SkillBallLimited ball )
			: base( 0, 0 )
		{
			this.Closable=true;
            ...
            this.AddLabel(265, 440, 0, @"Foresic Evaluation");  //51
            //**********************************************************
	...
	public class SkillBallLimited : Item
	{ 
		[Constructible] 
		public SkillBallLimited() :  base( 0xE73 ) 
		{ 
			Weight = 1.0; 
			Hue = 105; 
        ...
        public SkillBallLimited( Serial serial ) : base( serial ) 
		{ 
		} 
