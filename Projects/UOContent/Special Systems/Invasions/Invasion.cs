...
namespace Server
{
    public class TownInvasion
    {
        ...
        private void Spawn()
        {
            ...
            MonsterSpawnEntry[] entries = null;

            switch (_TownMonsterType)
            {
                default:
                case TownMonsterType.Abyss: entries = MonsterSpawnEntry.Abyss; break;
                case TownMonsterType.Arachnid: entries = MonsterSpawnEntry.Arachnid; break;
                case TownMonsterType.DragonKind: entries = MonsterSpawnEntry.DragonKind; break;
                case TownMonsterType.Elementals: entries = MonsterSpawnEntry.Elementals; break;
                case TownMonsterType.Humanoid: entries = MonsterSpawnEntry.Humanoid; break;
                case TownMonsterType.Ophidian: entries = MonsterSpawnEntry.Ophidian; break;
                case TownMonsterType.OrcsandRatmen: entries = MonsterSpawnEntry.OrcsandRatmen; break;
                case TownMonsterType.OreElementals: entries = MonsterSpawnEntry.OreElementals; break;
                case TownMonsterType.Snakes: entries = MonsterSpawnEntry.Snakes; break;
                case TownMonsterType.Undead: entries = MonsterSpawnEntry.Undead; break;
            }
        ...
        public void CheckSpawn()
        {
            ...
            if (DateTime.UtcNow >= _lastAnnounce + TimeSpan.FromMinutes(1))
            {
                ...
                {
                    tc.PublicOverheadMessage(Network.MessageType.Yell, 0, false, message);
                }
