...
namespace System.CustomizableVendor
{
                ...
                case 0:
                    {
                        ...
                        try { string name = reader.ReadString(); m_Type = AssemblyHandler.FindTypeByName(name); }
                        catch { }
    ...
    public class Reward : Item, ICloneable
    {
        ...
        public class RestockInfo
        {
            ...
            public RestockInfo(IGenericReader reader)
            {
        ...
        public override void Deserialize(IGenericReader reader)
        {
            ...
            switch (version)
            {
                ...
                case 0:
                    {
                        m_Reward = reader.ReadEntity<Item>();
    ...
    public class EditItemGump : Gump
    {
        ...
        public Reward.RestockInfo GetRestockInfo(RelayInfo info)
        {
            if (m_RestockOpen)
            {
                ...
                int.TryParse(hour, out numHours);
                int.TryParse(minute, out numMinutes);
                int.TryParse(beginAmount, out numBegin);
                int.TryParse(max, out numMax);
                int.TryParse(restockAmount, out numRestockAmnt);
    ...
    public class Exhibit : Item
    {
        ...
        public override void SendPropertiesTo(Mobile from)
        {
            ...
            from.SendOPLPacketTo(from.NetState);
        ...
        public override void Deserialize(IGenericReader reader)
        {
            ...
            if (reader.ReadBool())
            {
                m_Reward = reader.ReadEntity<Reward>();

                m_Vendor = (IRewardVendor)reader.ReadEntity<Mobile>();
            ...
            try
            {
                if (info.ButtonID % 2 == 0) //even ID: Copy Vendor
                {
                    ...
                    else
                    {
                        ...
                        //var gumps = new WarningGump(1060635, 30720, "Warning: You will lose all saved items on " + m_Vendor.GetName(), 0xFFC000, 420, 400, new WarningGumpCallback(CopyVendor_Callback));


                        m.SendGump(new WarningGump(1060635, 30720, "Warning: You will lose all saved items on " + m_Vendor.GetName(), 0xFFC000, 420, 400, okay => CopyVendor_Callback(m, okay, store)));
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            if (info.ButtonID % 2 == 0) //even
            {
                try
                {
                    ...
                    m.SendGump(new WarningGump(1060635, 30720, "Warning: Are you sure you want to remove " + r.Title, 0xFFC000, 420, 400, okay => DeleteReward_Callback(m, okay, store)));
    ...
    public class DisplayBox : LargeCrate, IEnumerable
    {
        ...
        public override void Serialize(IGenericWriter writer)
        {
            ...
            foreach (KeyValuePair<Reward, MetalBox> kvp in m_Boxes)
            {
                ...
                writer.Write((MetalBox)kvp.Value);
            }
        ...
        public override void Deserialize(IGenericReader reader)
        {
            ...
            if (count > 0)
            {
                ...
                {
                    Reward r = reader.ReadEntity<Reward>();
                    MetalBox box = reader.ReadEntity<MetalBox>();
        ...
        void IRewardVendorGump.Send(Mobile m)
        {
            ...
            if (m_BVendor != null)
            {
                ...
                if (m_List.Count > 0)
                {
                    ...
                    m.NetState.SendVendorBuyContent(m_List);
                    m.NetState.SendVendorBuyList(m_BVendor, m_List);
                    m.NetState.SendDisplayBuyList(m_BVendor.Serial);
                    ...
                    if (m_Opls != null)
                    {
                        ...
                        {
                            m.NetState.Send(m_Opls[i].Buffer);
                            //m.NetState.Send(m_Opls[i]);
    ...
    public class MobileRewardVendor : Banker, IRewardVendor
    {
        ...
        public override void Serialize(IGenericWriter writer)
        {
            ...
            if (count > 0)
            {
                for (int i = 0; i < count; i++)
                {
                    writer.Write((Reward)m_Rewards[i]);
                }
            }

            writer.Write((Currency)m_Currency);
            writer.Write((string)m_Menu.Name);
            writer.Write((DisplayBox)m_Box);
        }
                ...
                case 0:
                    {
                        ...
                        m_Currency = reader.ReadEntity<Currency>();

                        try { string name = reader.ReadString(); m_Menu = AssemblyHandler.FindTypeByName(name); }
                        catch { m_Menu = typeof(JewlRewardGump); }

                        m_Box = reader.ReadEntity<DisplayBox>();
    ...
    public class StoneRewardVendor : Item, IRewardVendor
    {
        ...
        public override void Serialize(IGenericWriter writer)
        {
            ...
            writer.Write((string)m_Menu.Name);
            writer.Write((DisplayBox)m_Box);
            writer.Write((StoneRewardHolder)m_Box_Holder);
        }
        ...
        public override void Deserialize(IGenericReader reader)
        {
            ...
            m_Box = reader.ReadEntity<DisplayBox>();
            m_Box_Holder = reader.ReadEntity<StoneRewardHolder>();
        }
    }
