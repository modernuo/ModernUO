            ...
            if (_list != null && info.ButtonID == 1) // Remove now
            {
                ...
                if (switches.Length > 0)
                {
                    ...
                    if (_list.Count > 0)
                    {
                        ...
                        from.SendGump(new HouseRemoveGump(_number, _list, _house, _accountOf));
                        return;
                    }
                }
            }
                ...
                case 2: // List of co-owners
                    {
                        ...
                        from.CloseGump<HouseListGump>();
                        from.CloseGump<HouseRemoveGump>();
                        from.SendGump(new HouseListGump(1011275, _house.CoOwners, _house, false));
                ...
                case 4: // Remove co-owner
                    {
                        if (isOwner)
                        {
                            ...
                            from.CloseGump<HouseListGump>();
                            from.CloseGump<HouseRemoveGump>();
                            from.SendGump(new HouseRemoveGump(1011274, _house.CoOwners, _house, false));
                        }
                        else
                        {
                ...
                case 6: // List friends
                    {
                        ...
                        from.CloseGump<HouseListGump>();
                        from.CloseGump<HouseRemoveGump>();
                        from.SendGump(new HouseListGump(1011273, _house.Friends, _house, false));
                ...
                case 8: // Remove friend
                    {
                        if (isCoOwner)
                        {
                            ...
                            from.CloseGump<HouseListGump>();
                            from.CloseGump<HouseRemoveGump>();
                            from.SendGump(new HouseRemoveGump(1011272, _house.Friends, _house, false));
                        }
                        else
                        {
                ...
                case 12: // List bans
                    {
                        ...
                        from.CloseGump<HouseListGump>();
                        from.CloseGump<HouseRemoveGump>();
                        from.SendGump(new HouseListGump(1011271, _house.Bans, _house, true));
                ...
                case 13: // Remove ban
                    {
                        ...
                        from.CloseGump<HouseListGump>();
                        from.CloseGump<HouseRemoveGump>();
                        from.SendGump(new HouseRemoveGump(1011269, _house.Bans, _house, true));
