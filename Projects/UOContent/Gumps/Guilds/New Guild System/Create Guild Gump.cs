...
namespace Server.Guilds
{
    public class CreateGuildGump : Gump
    {
        public CreateGuildGump(PlayerMobile pm, string guildName = "Guild Name", string guildAbbrev = "") : base(10, 10)
        {
            ...
            AddHtmlLocalized(25, 60, 450, 60, 1062940,
                0x0); // As you are not a member of any guild, you can create your own by providing a unique guild name and paying the standard guild registration fee.
