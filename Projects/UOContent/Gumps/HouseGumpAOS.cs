        ...
        public HouseGumpAOS(HouseGumpPageAOS page, Mobile from, BaseHouse house) : base(50, 40)
        {
            ...
            switch (page)
            {
                case HouseGumpPageAOS.Information:
                    {
                        ...
                        AddHtmlLocalized(20, 210, 380, 20, house is HouseFoundation ? 1060681 : 1060680,
                            SelectedColor); // This is a (pre | custom)-built house.
                        AddHtmlLocalized(20, 230, 380, 20, house.Public ? 1060678 : 1060679,
                            SelectedColor); // This house is (private | open to the public).
                        ...
                        switch (house.DecayType)
                        {
                            ...
                            case DecayType.AutoRefresh:
                                {
                                    AddHtmlLocalized(20, 250, 380, 20, 1062209,
                                        SelectedColor); // This house is <a href = "?ForceTopic97">Automatically</a> refreshed.
                                    break;
                                }
                            case DecayType.ManualRefresh:
                                {
                                    AddHtmlLocalized(20, 250, 380, 20, 1062208,
                                        SelectedColor); // This house is <a href = "?ForceTopic97">Grandfathered</a>.
                                    break;
                                }
                            case DecayType.Condemned:
                                {
                                    AddHtmlLocalized(20, 250, 380, 20, 1062207,
                                        WarningColor); // This house is <a href = "?ForceTopic97">Condemned</a>.
                                    break;
                                }
                        }
                ...
                case HouseGumpPageAOS.Customize:
                    {
                        ...
                        AddButtonLabeled(10, 120, GetButtonID(5, 0), 1060759,
                            isOwner && !isCustomizable && house.ConvertEntry != null); // Convert Into Customizable House
                        AddButtonLabeled(10, 160, GetButtonID(5, 1), 1060765, isOwner && isCustomizable); // Customize This House
                        AddButtonLabeled(10, 180, GetButtonID(5, 2), 1060760,
                            isOwner && house.MovingCrate != null); // Relocate Moving Crate
                        AddButtonLabeled(10, 210, GetButtonID(5, 3), 1060761, isOwner && house.Public); // Change House Sign
                        AddButtonLabeled(10, 230, GetButtonID(5, 4), 1060762,
                            isOwner && isCustomizable); // Change House Sign Hanger
                        AddButtonLabeled(10, 250, GetButtonID(5, 5), 1060763,
                            isOwner && isCustomizable && ((HouseFoundation)house).Signpost != null); // Change Signpost
                        AddButtonLabeled(10, 280, GetButtonID(5, 6), 1062004,
                            isOwner && isCustomizable); // Change Foundation Style
                ...
                case HouseGumpPageAOS.Ownership:
                    {
                        AddButtonLabeled(10, 130, GetButtonID(6, 0), 1061794,
                            isOwner && house.MovingCrate == null && house.InternalizedVendors.Count == 0); // Demolish House
                            ...
                            case 5: // Add a Friend
                                {
                                    ...
                                    {
                                        from.SendLocalizedMessage(
                                            501317); // Target the person you wish to name a friend of your household.
                            ...
                            case 0: // Demolish
                                {
                                    if (isOwner && m_House.MovingCrate == null && m_House.InternalizedVendors.Count == 0)
                                    {
                                        ...
                                        {
                                            from.SendLocalizedMessage(
                                                1080178); // You must wait one hour between each house demolition.
                                        }
                                        else
                                        {
                            ...
                            case 1: // Trade House
                                {
                                    if (isOwner)
                                    {
                                        ...
                                        {
                                            from.SendLocalizedMessage(
                                                501309); // Target the person to whom you wish to give this house.
