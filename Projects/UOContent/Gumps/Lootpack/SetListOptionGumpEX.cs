...
namespace Server.Gumps
{
        ...
        public class SetListOptionGumpEx : Gump
        {
            ...
            public SetListOptionGumpEx(
                PropertyInfo prop, Mobile mobile, object o, Stack<StackEntry> stack, int propspage,
                List<object> list, string[] names, object[] values, int returnMenu = 0
            ...
            public override void OnResponse(NetState sender, RelayInfo info)
            {
                ...
                if (index >= 0 && index < m_Values.Length)
                {
                    try
                    {
                        ...
                        {
                        //m_Property.SetValue(m_Object, m_Property, null);
                ...
                if (returnmenu == 0) m_Mobile.SendGump(new PropertiesGump(m_Mobile, m_Object, m_Stack, m_List, m_Page));
                else m_Mobile.SendGump(new LootPackItemEditor(m_Mobile, m_Object, m_Stack, m_List, m_Page));
