...
namespace Server.Gumps
{
    public class SetGumpEX : Gump
    {
        ...
        private int returnMenu = 0;
     
        public SetGumpEX(
            PropertyInfo prop, Mobile mobile, object o, Stack<StackEntry> stack, int page, List<object> list,int menu=0
        ) : base(
            GumpOffsetX,
            GumpOffsetY
        )
            ...
            if (shouldSend)
            {
                switch (returnMenu)
                {
                    case 0:
                        ...
                        break;
                    case 2:
                        m_Mobile.SendGump(new LootPackItemEditor(m_Mobile, m_Object, m_Stack, m_List, m_Page));
                        break;
                    default:
                        break;
                }
