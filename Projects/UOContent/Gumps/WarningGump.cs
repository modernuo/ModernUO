namespace Server.Gumps
{
    ...
    public class WarningGump : Gump
    {
        ...
        public WarningGump(int header, int headerColor, object content, int contentColor, int width, int height,
            WarningGumpCallback callback = null, bool cancelButton = true) : base((640 - width) / 2, (480 - height) / 2)
        {
            m_Callback = callback;
