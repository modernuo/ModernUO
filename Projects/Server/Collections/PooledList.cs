...
#pragma warning restore CA1825
        ...
        public int Capacity
        {
            ...
            set
            {
                ...
                if (value != _items.Length)
                {
                    if (value > 0)
                    {
                        T[] newItems = ArrayPool<T>.Shared.Rent(_size);
                        if (_size > 0)
                        {
        ...
        object? IList.this[int index]
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException($"{nameof(value)} is the wrong type.");
                }
            }
        }
        ...
        int IList.Add(object? item)
        {
            ...
            {
                throw new ArgumentException($"{nameof(item)} is the wrong type.");
            }
        ...
        public T[] ToPooledArray()
        {
            ...
            T[] array = ArrayPool<T>.Shared.Rent(_size);
            Array.Copy(_items, array, _size);
            return array;
        }
