...
namespace Server.Items
{
    public partial class Container
    {
            ...
            where TFilter : struct, IFilter<Item, TResult>
        {
            ...
            {
                return new(container, new ChainFilter<Item, TResult, TTResult, TFilter, TTFilter>(this.filter, filter));
            }

            public AllItemsEnumerable<ChainFilter<Item, TResult, TTResult, TFilter, TypeFilter<TResult, TTResult>>, TTResult> OfType<TTResult>()
            {
                return new(container, new ChainFilter<Item, TResult, TTResult, TFilter, TypeFilter<TResult, TTResult>>(filter, default));
            }
