...
namespace Server
{
  public partial class Timer
  {
    ...
    public static Timer DelayCall<T1, T2, T3>(TimeSpan delay, TimeSpan interval, TimerStateCallback<T1, T2, T3> callback, T1 t1, T2 t2, T3 t3) =>
      DelayCall(delay, interval, 0, callback, t1, t2, t3);

    public static Timer DelayCall<T1, T2, T3>(TimeSpan delay, TimeSpan interval, int count, TimerStateCallback<T1, T2, T3> callback,
      T1 t1, T2 t2, T3 t3)
    {
