...
namespace Server
{
    ...
    public partial class Timer
    {
        ...
        public static Timer DelayCall<T1, T2>(TimeSpan delay, TimeSpan interval, int count,
        ...
        public static Timer DelayCall<T1, T2, T3>(TimeSpan delay, TimerStateCallback<T1, T2, T3> callback, T1 t1, T2 t2,
            T3 t3) =>
        ...
        public static Timer DelayCall<T1, T2, T3, T4>(TimerStateCallback<T1, T2, T3, T4> callback, T1 t1, T2 t2, T3 t3,
            T4 t4) =>
        ...
        private class DelayStateCallTimer<T1, T2, T3, T4> : Timer
        {
            ...
            public DelayStateCallTimer(TimeSpan delay, TimeSpan interval, int count,
