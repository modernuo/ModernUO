    ...
    public sealed class MultiComponentList
    {
        ...
        public void Add(int itemID, int x, int y, int z)
        {
            ...
            if (vx >= 0 && vx < Width && vy >= 0 && vy < Height)
            {
                ...
                newList[oldList.Length] =
                    new MultiTileEntry((ushort)itemID, (short)x, (short)y, (short)z, TileFlag.Background);
            ...
            for (var x = 0; x < newWidth; ++x)
                for (var y = 0; y < newHeight; ++y)
                {
                    ...
                    for (var i = 0; i < tiles.Length; ++i)
                    {
                        ...
                        List[index++] = new MultiTileEntry((ushort)tile.ID, (short)vx, (short)vy, (short)tile.Z,
                            TileFlag.Background);
                    }
                }
        }
